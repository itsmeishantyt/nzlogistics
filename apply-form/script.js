...
function getDefaultConfig() {
    return [
        ...
        { id: 'license_expiry', page_group: 4, type: 'date', display_mode: 'page', title: 'License Expiration Date (DD/MM/YYYY)', placeholder: 'DD/MM/YYYY', required: true },
        { id: 'dot_medical_expiry', page_group: 4, type: 'date', display_mode: 'page', title: 'DOT Medical Card Expiration Date (if applicable) (DD/MM/YYYY)', placeholder: 'DD/MM/YYYY', required: false },
